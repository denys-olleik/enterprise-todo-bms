namespace EnterpriseToDo.Models.ChartOfAccount
{
  //public class GetAllChartOfAccountsViewModel
  //{
  //  public List<ChartOfAccountViewModel> Accounts = new List<ChartOfAccountViewModel>();
