...
2. zip the published contents and upload to the server to `/var/www/enterprisetodo` using winscp.
...
If the address bar has to change, the server must change it, not javascript.
